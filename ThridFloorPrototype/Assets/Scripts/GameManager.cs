...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private Sprite[] spriteButtonWinLose;
    [SerializeField] private TextMeshProUGUI textResult;
    [SerializeField] private TextMeshProUGUI textResultBtn;
    ...
    public void CheckGameWins()
    {
        if (isWin && !isLose)
        {
            ...
            Debug.Log($"{DataCenter.Instance.GetPlayerData().region}, {DataCenter.Instance.GetPlayerData().stage}");
            Debug.Log($"{KillCount}, {StarCount}");
    ...
    private void WinCondition()
    {
        ...
        imgButtonWinLose.sprite = spriteButtonWinLose[0];
    ...
    private void LoseCondition()
    {
        ...
        imgButtonWinLose.sprite = spriteButtonWinLose[1];
    ...
    {
        StartCoroutine(GetLevelDataFromCsv(DataCenter.Instance.Region, DataCenter.Instance.Stage, (levelData) =>
        {
            if (levelData == null)
            {
