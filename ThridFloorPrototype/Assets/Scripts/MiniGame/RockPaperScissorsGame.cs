...
namespace Assets.HeroEditor4D.Common.Scripts
{
    public class RockPaperScissorsGame : MonoBehaviour
    {
        ...
        public TextMeshProUGUI resultTextButton;
        public Image resultImageButton;
        public Sprite[] resultSpriteButton;
        ...
        IEnumerator EndGameAPI()
        {
            if (playerHP <= 0)
            {
                ...
                resultImageButton.sprite = resultSpriteButton[1];
        ...
        IEnumerator EndGameWin()
        {
            ...
            resultImageButton.sprite = resultSpriteButton[0];
