...
namespace Assets.HeroEditor4D.Common.Scripts
{
    public class TapGameController : MonoBehaviour
    {
        ...
        [SerializeField] private Image imgResultButton;
        [SerializeField] private Sprite[] resultSpriteButton;
        [SerializeField] private TextMeshProUGUI resultTextButton;
        ...
        private int GetBossPrefabIndex(int region, int stage)
        {
            ...
            return -1; // Return -1 if no valid prefab index is found
        }
        ...
        void EndGameWinTimeOut()
        {
            ...
            PlayerAnimationManager.SetState(Enums.CharacterState.Dance);
            ...
            imgResultButton.sprite = resultSpriteButton[0];
            resultTextButton.text = "Next";
            resultText.text = "Win";
        ...
        void DetermineWinner()
        {
            if (!scoreSent) 
            {
                ...
                else
                {
                    ...
                    SoundManager.Instance.PlayVFX(deadSound);
                    imgResultButton.sprite = resultSpriteButton[1];
                    resultTextButton.text = "Try again";
